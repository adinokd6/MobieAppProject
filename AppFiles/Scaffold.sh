...
rails generate scaffold Certificate CertificateId:string Name:string Grade:string Description:text student:references
...
rails generate scaffold Email EmailId:string OwnerId:string EmailAddress:string student:references
...
rails generate Employer EmployerId:string EmailId:string
